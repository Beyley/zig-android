//taken from https://github.com/MasterQ32/ZigAndroidTemplate/blob/a7907838e0db655097ef912dd575fee9b8cb3bec/tools/zip_add.zig
...
pub fn main() !u8 {
    ...
    // const zip = c.zip_open(out_file.ptr, 0, 'a') orelse return error.FileNotFound;
